...
def deleteMail():
    ...
    mailBoxTarget = "INBOX"
    SpeakText("From where do you want to delete the mail ? Say 1 for Inbox. Say 2 for Sent Mailbox. Say 3 for Drafts. Say 4 for important mails. Say 5 for Spam. Say 6 for Starred Mails. Say 7 for Bin.")
    cmb = speech_to_text()
    ...
    SpeakText("Say 1 to delete mail from a specific sender. Say 2 to delete mail with respect to the subject of the mail. Say 3 to delete ma")
    ...
    if mailSearchChoice == "1" or mailSearchChoice.lower() == "one":
        ...
        SpeakText("Wrong choice. Performing default operation. Please mention the subject of the mail you want to Delete.")
        searchSub = speech_to_text()
        status, messages = M.search(None, f'SUBJECT "{searchSub}"')
...
def main():
    ...
    if EMAIL_ID != "" and PASSWORD != "":
        ...
        SpeakText("Choose and speak out the option number for the task you want to perform. Say 1 to send a mail. Say 2 to get your mailbox status. Say 3 to search a mail. Say 4 to get the last 3 mails. Say 5 to delete a mail.")
